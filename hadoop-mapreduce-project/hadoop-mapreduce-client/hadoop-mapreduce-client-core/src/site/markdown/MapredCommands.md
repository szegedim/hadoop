...
Usage: `mapred frameworkupload -target <target> | [-fs <filesystem>] | [-input <classpath>] | [-blacklist <list>] | [-whitelist <list>] | [-initialReplication <num>] | [-acceptableReplication <num>] | [-finalReplication <num>] | [-timeout <seconds>] | [-nosymlink]`
